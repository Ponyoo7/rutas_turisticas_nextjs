...
export function FeaturedRouteCard({
  ...
  const resolvedPrimaryBadge = primaryBadge ?? t('common.featured')
      ...
      <div className="flex flex-col gap-4 p-5">
        <div>
          <p className="text-[11px] font-bold uppercase tracking-[0.28em] text-artis-primary/45">
            {t('profile.favoriteRoutes.recommendedType')}
          </p>
        ...
        <div className="flex flex-col gap-2">
          <p className="text-sm font-semibold text-artis-primary">
            {t('profile.favoriteRoutes.firstStops')}
          </p>
          ...
          {route.places.length > previewPlaces.length && (
            <p className="text-xs font-medium uppercase tracking-[0.18em] text-gray-500">
              {t('profile.favoriteRoutes.moreStops', {
                count: route.places.length - previewPlaces.length,
              })}
            </p>
          )}
        </div>
